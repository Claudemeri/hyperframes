...
> **Open design question.** Whether `prepare` belongs in media-use is not settled — the video workflow could write its own snippets, with media-use stopping at the AssetRecord. Listed as a proposal; decide with the team (open item from the 2026-06-04 review).
