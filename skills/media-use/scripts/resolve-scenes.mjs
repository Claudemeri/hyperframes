#!/usr/bin/env node
// resolve-scenes — the media-use ↔ host-workflow bridge, AGENT-FIRST (decided 2026-06-10).
//
...
// <project>/.media-use/{manifest.jsonl,index.md,reports/} (thin ledger, path == composition path) ·
