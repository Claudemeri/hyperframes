...
// Reads a persisted resolve report (intent + candidates + pick); text-only LLM judge (RWA-style review);
...
// Usage: node select-oracle.mjs --report <.media-use/reports/resolve_*.json> [--rubric "..."]
