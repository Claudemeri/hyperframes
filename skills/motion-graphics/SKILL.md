...
- **Reuse-first:** the in-ecosystem analog of agent-opus's LLM-generated Remotion templates is "compose catalog blocks + `hyperframes-animation` rules". HF's paused GSAP timeline ≙ Remotion's `useCurrentFrame`.
